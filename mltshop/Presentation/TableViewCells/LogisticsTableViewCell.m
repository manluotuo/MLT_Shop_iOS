...
- (void)initCellView {
    ...
    view = [[UIView alloc] initWithFrame:CGRectMake(H_50, self.timeLable.y+self.timeLable.height+H_19, WIDTH-H_60, 1)];
...
- (void)setNewData:(LogisticsModel *)_newData andType:(BOOL)type {
    ...
    view.frame = CGRectMake(H_50, self.timeLable.y+self.timeLable.height+H_19, WIDTH-H_60, 1);
