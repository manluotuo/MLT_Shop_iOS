 ...
 * ViewPagerOptionTabWidthArray: an array with all tab width
...
typedef NS_ENUM(NSUInteger, ViewPagerOption) {
    ...
    ViewPagerOptionTabViewWidth,
    ViewPagerOptionTabOffset,
    ViewPagerOptionTabWidth,
    ViewPagerOptionTabWidthArray,
...
@property (nonatomic, assign)BOOL notAllowScrolled;
