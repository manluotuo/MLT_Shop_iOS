...
- (UIScrollView*)fakeToolbar {
    ...
    for (RFToolbarButton *eachButton in _buttonsToAdd) {
        originFrame = CGRectMake([[UIScreen mainScreen] bounds].size.width-eachButton.frame.size.width-20, 0, eachButton.frame.size.width, eachButton.frame.size.height);
