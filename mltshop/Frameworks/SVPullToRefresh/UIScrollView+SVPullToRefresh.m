...
- (void)resetPullToRefreshViewTitles:(NSMutableArray *)titleArray
{
    [self.pullToRefreshView setTitles:titleArray];
}
...
- (void)layoutSubviews {
    CGFloat remainingWidth = self.superview.bounds.size.width-120;
    float position = 0.50;
